...
public static class WebhookHeaderNames
{
    ...
    /// <summary>Header carrying the request signature, passed as <c>signatureHeader</c> to <see cref="WebhookVerifier.VerifyAndParse"/>.</summary>
    public const string Signature = "X-Atlas-Webhook-Signature";

    /// <summary>Header carrying the request's Unix timestamp, passed as <c>timestampHeader</c> to <see cref="WebhookVerifier.VerifyAndParse"/>.</summary>
